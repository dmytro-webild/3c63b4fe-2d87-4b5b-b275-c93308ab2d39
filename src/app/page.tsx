...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        ...
        { name: "Linda P.", handle: "@lp_doglove", testimonial: "Finally, a place that understands senior dogs. So gentle!", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/man-with-greyhound-dog-home-couch_23-2150283067.jpg?_wi=1" },
      ...
      marqueeItems={[
        ...
        { type: "text", text: "Gentle Handling" },
        { type: "text", text: "Senior Speciality" },
        { type: "text", text: "Blueberry Facials" },
        { type: "text", text: "Stress-free Spa" },
      ]}
    />
  </div>
  ...
  <div id="services" data-section="services">
      ...
      useInvertedBackground={false}
      features={[
        { tag: "Full Care", title: "Full Spa Groom", subtitle: "Bath, Cut, Nails & More", description: "Comprehensive grooming service including bath, haircut, nails, and teeth cleaning.", imageSrc: "http://img.b2bpic.net/free-photo/man-with-greyhound-dog-home-couch_23-2150283067.jpg?_wi=2" },
        { tag: "Add-on", title: "Blueberry Facial", subtitle: "Refresh & Clean", description: "Deep cleaning blueberry facial for a fresh, clean scent and happy pup.", imageSrc: "http://img.b2bpic.net/free-photo/top-view-asmr-microphone-with-objects-sound_23-2149319262.jpg?_wi=2" },
        { tag: "Specialty", title: "Senior Spa Care", subtitle: "Gentle Handling", description: "Specially tailored grooming for senior dogs needing extra patience and care.", imageSrc: "http://img.b2bpic.net/free-photo/close-up-female-vet-hand-examining-dog-flea-with-comb-clinic_23-2147928587.jpg?_wi=2" },
      ]}
  ...
  <div id="metrics" data-section="metrics">
      ...
      useInvertedBackground={false}
      metrics={[
        { id: "m1", value: "619+", title: "Google Reviews", items: ["Top-rated local spa", "Reliable grooming experts"] },
        { id: "m2", value: "4.9", title: "Average Rating", items: ["Exceptional quality", "Consistent feedback"] },
        { id: "m3", value: "100%", title: "Gentle Care", items: ["Stress-free focus", "Expert handling"] },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      useInvertedBackground={false}
      testimonials={[
        { id: "1", name: "Alice M.", handle: "@alicem", testimonial: "Jamie is wonderful! My dog usually hates grooming but she was so calm here.", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/happy-french-bulldog-striped-shirt_23-2151995696.jpg" },
        { id: "2", name: "Bob K.", handle: "@bobk", testimonial: "Fantastic service. They handled my matted dog with such grace and kindness.", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/outdoor-portrait-curly-european-tanned-woman-holds-happy-pet-dog-pomeranian-spitz_343596-1496.jpg" },
        { id: "3", name: "Carla F.", handle: "@carlaf", testimonial: "The best skunk bath rescue! My house smells great again thanks to you.", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/cute-girl-playing-with-little-dog_1157-32627.jpg" },
        { id: "4", name: "Dave R.", handle: "@daver", testimonial: "So patient with my anxious senior pup. Highly recommend!", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/studio-shot-cute-border-collie-dog_23-2148097502.jpg" },
        { id: "5", name: "Elena W.", handle: "@elenaw", testimonial: "Five star service. Very professional, clean, and kind staff.", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/vertical-portrait-funny-english-bulldog-puppy-wrapped-blanket-pink-surface_181624-43641.jpg" },
      ]}
      showRating={true}
