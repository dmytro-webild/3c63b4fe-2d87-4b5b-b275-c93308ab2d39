        ...
        <div className="pt-32 pb-20">
          <LegalSection
            ...
            sections={[
              ...
              { heading: "How We Use Your Information", content: { type: "list", items: ["To schedule and manage your grooming appointments", "To provide personalized care for your pets"] } },
              { heading: "Data Security", content: { type: "paragraph", text: "We implement industry-standard security measures." } }
            ]}
          />
        </div>
        <FooterBase
